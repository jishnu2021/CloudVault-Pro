        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, fetch("https://cloudvault-pro.onrender.com/user/".concat(parsedUser.id, "/files?page=1&limit=50"))];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        xhr_1.open('POST', "https://cloudvault-pro.onrender.com/user/".concat(parsedUser.id, "/upload"));
                        xhr_1.send(formData);
                    })];
            }
            catch (error) {
