        ...
        var fetchPlans = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, fetch('https://cloudvault-pro.onrender.com/api/subscription/plans')];
                    case 1:
                        response = _a.sent();
    ...
    var handleSubscribe = function (planId) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("https://cloudvault-pro.onrender.com/api/user/".concat(parsedUser.id, "/subscription/create-order"), {
                            method: 'POST',
                            headers: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("https://cloudvault-pro.onrender.com/api/user/".concat(parsedUser.id, "/subscription/verify-payment"), {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
